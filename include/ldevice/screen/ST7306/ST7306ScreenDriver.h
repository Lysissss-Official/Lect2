...
class ST7306ScreenDriver final : public ScreenDriver {
public:
    struct Config {
    ...
    explicit ST7306ScreenDriver(const Config& config);
    ~ST7306ScreenDriver() override;

    ST7306ScreenDriver(const ST7306ScreenDriver&) = delete;
    ST7306ScreenDriver& operator=(const ST7306ScreenDriver&) = delete;
